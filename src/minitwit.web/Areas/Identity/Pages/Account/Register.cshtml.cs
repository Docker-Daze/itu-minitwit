...
namespace minitwit.web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private User CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(minitwit.core.User)}'. " +
                    $"Ensure that '{nameof(minitwit.core.User)}' is not an abstract class and has a parameterless constructor, or alternatively " +
